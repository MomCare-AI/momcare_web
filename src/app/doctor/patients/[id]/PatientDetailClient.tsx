...
type TabKey = 'details' | 'settings' | 'monitoring_time' | 'devices' | 'patient_documents' | 'instructional_videos' | 'vitals' | 'alerts'
...
export default function PatientDetailClient({ patientId }: { patientId: string }) {
  ...
  const { data: patient, isLoading: loadingPatient } = useQuery<any>({
          ...
          return (
            ...
            >
              ...
              {tab.key === 'alerts' && pendingAlerts.length > 0 && (
                <span className={`ml-2 inline-flex h-5 min-w-5 items-center justify-center rounded-full text-[10px] font-bold tabular-nums ${isActive ? 'bg-surface text-pine' : 'bg-[var(--color-clay)] text-surface'}`}>
            ...
            <div className="col-span-2 space-y-6">
              <div className="rounded-[10px] border border-line bg-panel p-6">
                <div className="flex items-center justify-between mb-6">
                  <h2 className="font-display text-lg font-semibold text-pine">Basic Patient Information</h2>
                </div>
                ...
                {loadingPatient ? (
                  ...
                  <div className="grid grid-cols-2 gap-y-6 gap-x-8 text-sm">
                    <div>
                      ...
                      <span className="font-medium text-ink">{patient?.user?.full_name || '—'}</span>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <span className="font-medium text-ink">{patient?.due_date ? new Date(patient.due_date).toLocaleDateString() : '—'}</span>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <span className="font-medium text-ink">{patient?.user?.phone_number || '—'}</span>
                    </div>
                    <div>
                      <span className="block text-xs text-ink-muted mb-1">Preferred Language :</span>
                ...
                <table className="w-full text-left text-sm">
                  ...
                  <tbody className="divide-y divide-line bg-surface">
                    <tr>
                      ...
                      <td className="px-4 py-3 text-pine hover:underline cursor-pointer font-medium">Unassign</td>
                    </tr>
                    <tr>
