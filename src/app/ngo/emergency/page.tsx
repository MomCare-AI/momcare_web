...
export default function NgoEmergency() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="font-display text-2xl font-semibold text-pine">Emergency Coordination</h1>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        {/* Map placeholder */}
        <div className="rounded-[10px] border border-line bg-panel p-6">
          <h2 className="mb-4 font-display text-base font-semibold text-pine">Map View</h2>
      ...
      {/* Response log */}
      <div className="rounded-[10px] border border-line bg-panel p-6">
        <h2 className="mb-4 font-display text-base font-semibold text-pine">Response Log</h2>
        <p className="text-xs text-ink-muted">
          Append-only log of all emergency responses with timestamps. Actions taken, responders
          assigned, and outcomes will be recorded here.
        </p>
      </div>
    </div>
  )
